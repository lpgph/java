...
public class MobileUtil {
	 ...
	 */
	private static String[] mobileUserAgents = new String[] { "Nokia", // 诺基亚:Mozilla/5.0(Nokia5800,XpressMusic)/UC/AppleWebkit(like,Gecko)/Safari/530
			...
			"MIDP-2", // j2me2.0:Mozilla/5.0(SymbianOS/9.3;
						// U;Series60/3.2/NokiaE75-1 /110.48.125
						// Profile/MIDP-2.1/Configuration/CLDC-1.1
						// )/AppleWebKit/413 (KHTML like/Gecko) Safari/413
			"CLDC1.1", // M600/MIDP2.0/CLDC1.1/Screen-240X320
			"SymbianOS", // 塞班系统
			"MAUI", // MTK山寨机默认ua
			"UNTRUSTED/1.0", // 疑似山寨机的ua
			"Windows CE", // Windows CE，Mozilla/4.0 (compatible; MSIE
	...
	/**
	 * 根据当前请求的特征，判断该请求是否来自手机终端</br>
	 * 主要检测特殊的头信息，以及user-Agent这个header</br>
